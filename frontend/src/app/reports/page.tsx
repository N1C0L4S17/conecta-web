...
export default function ReportsPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* 👇 md:pl-[76px] reserva el hueco del riel fijo colapsado (76px).
          No es dinámico con el estado "expanded" del Nav porque ese estado
          expande el sidebar como overlay flotante (shadow-floating), no
          como algo que deba empujar el layout. */}
      <div className="md:pl-[76px] transition-[padding] duration-300">
